...
## Additional Setup
You will want to make sure Lemur is pumping out over midi 0 and midi 1 for both decks to work in Traktor. In Traktor settings, make sure the control script is listening on all ports not just deamon 0 or 1. 
...
- 4 cues and roll pads (Borrowed from another template that wasn't mine.)
- Master volume
- Cue and split faders

Enjoy. If anyone wants to improve on the template or midi map please open a PR or DM me. Or fork it. 
